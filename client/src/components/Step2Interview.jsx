...
setIsSubmitting(false)
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-indigo-50 via-white to-indigo-100 flex items-center justify-center p-4 sm:p-6'>
        ...
        <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
         ...
         {!feedback ? ( <div className='flex items-center gap-4 mt-6'>
            ...
            disabled={isSubmitting}
              whileTap={{ scale: 0.95 }}
              className="flex-1 bg-gradient-to-r from-indigo-600 via-indigo-500 to-indigo-600 text-white py-3 sm:py-4 rounded-2xl shadow-xl hover:from-indigo-700 hover:via-indigo-600 hover:to-indigo-700 hover:shadow-2xl transition-all duration-300 font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
              >
